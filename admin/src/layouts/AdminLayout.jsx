...
import { LayoutDashboard, Users, GraduationCap, FolderKanban, FileText, Settings, LogOut, MapPin, Layers } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Members Management', path: '/members', icon: <Users size={20} /> },
    { name: 'Projects Management', path: '/projects', icon: <FolderKanban size={20} /> },
    { name: 'Reports Management', path: '/reports', icon: <FileText size={20} /> },
    { name: 'Chapters Management', path: '/chapters', icon: <MapPin size={20} /> },
    { name: 'Groups Management', path: '/groups', icon: <Layers size={20} /> },
