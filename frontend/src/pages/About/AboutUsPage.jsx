...
const AboutUsPage = () => {
  ...
  return (
    <div className="w-full bg-slate-50 font-sans min-h-screen pt-14">
      ...
      <section className="w-full bg-[#0A1435] py-16 relative z-20 shadow-[0_-20px_40px_rgba(0,0,0,0.05)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-[#FFC107]">
