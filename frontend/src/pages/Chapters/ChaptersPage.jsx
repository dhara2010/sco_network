...
import GujaratMap from '../../components/sections/GujaratMap';
import { Building2, Users, MapPin, Search, Plus, Calendar, ArrowRight } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchChapters = async () => {
      try {
        ...
        setChapters(data.filter(c => c.status === 'Approved' || c.status === 'Active' || c.status === 'approved' || c.status === 'active'));
      } catch (err) {
