...
const ContactUsPage = () => {
  return (
    <div className="w-full bg-gray-50 font-sans min-h-screen mt-14">
      ...
      {/* 1. Header Section */}
      <section className="sco-page-hero">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <motion.div 
            ...
            className="py-2"
          >
            <h2 className="text-xl font-extrabold mb-8">Direct Contact Details</h2>
            ...
            <div className="space-y-8 mb-10">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-sm font-bold mb-1">Head Office</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-sm font-bold mb-1">Helpdesk Email</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="text-sm font-bold mb-1">Phone Number</h3>
                  <a href="tel:+912222843210" className="text-sm hover: transition-colors">
                    +91 22 2284 3210
                  </a>
                </div>
              </div>
            ...
            <div className="bg-[#fffdf5] border border-[#ffecbc] rounded-2xl p-6 mb-8">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex justify-between items-center border-t border-[#ffecbc]/50 pt-3">
                  <span>Saturday:</span>
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-bold mr-2">Follow us:</span>
              <a href="#" onClick={(e) => { e.preventDefault(); alert('Social links coming soon!'); }} className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-[#115fc6] hover:text-white transition-colors">
        ...
        >
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-bold">Find us on the Map</h2>
            </div>
          </div>
          <div className="w-full h-[400px] bg-gray-100 relative">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none flex flex-col items-center">
              ...
              <div className="mt-2 bg-white text-[10px] font-bold px-4 py-1.5 rounded shadow border border-gray-100 uppercase tracking-widest">
                SCO Head Office
              </div>
            </div>
          </div>
