...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full flex items-center justify-center overflow-hidden bg-[#071B4D] mb-12 md:mb-16">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#071B4D]/60 via-[#071B4D]/70 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#071B4D]/80 via-[#071B4D]/20 to-transparent" />
      </div>

      {/* Main Content Area */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white text-xs font-bold tracking-widest mb-8 uppercase shadow-sm">
            Global Sathwara Network
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-[#FFC107] leading-[1.1] mb-6 drop-shadow-lg">
            Empowering Global <br className="hidden lg:block" />
            <span className="text-white">Trade Excellence</span>
          </h1>
          
          <p className="text-blue-50 text-lg md:text-xl max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed font-light drop-shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <Link to="/become-member" className="w-full sm:w-auto px-8 py-4 rounded-full bg-[#FFC107] text-[#071B4D] font-bold text-sm hover:bg-white transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group">
              Become a Member <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/about" className="w-full sm:w-auto px-8 py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold text-sm hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2 hover:border-white/40">
              Explore Network
            </Link>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="w-full lg:w-1/2 max-w-lg mx-auto relative group cursor-pointer"
          onClick={() => setIsModalOpen(true)}
        >
          <div className="absolute -inset-1 rounded-[2.5rem] bg-gradient-to-br from-white/10 to-white/0 blur-xl opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
