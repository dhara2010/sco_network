...
// @desc    Get single APPROVED project by ID or Slug
// @access  Public
router.get('/public/:id', async (req, res) => {
  try {
    ...
    if (mongoose.Types.ObjectId.isValid(id)) {
      const project = await Project.findOne({ _id: id, status: 'Approved' });
...
router.get('/admin', protect, authorize('Super Admin', 'Admin', 'Chapter Admin'), async (req, res) => {
  try {
...
// @access  Private (Admin)
router.post('/admin', protect, authorize('Super Admin', 'Admin', 'Chapter Admin'), async (req, res) => {
  try {
...
// @access  Private (Admin)
router.put('/admin/:id', protect, authorize('Super Admin', 'Admin', 'Chapter Admin'), async (req, res) => {
  try {
...
// @access  Private (Admin)
router.delete('/admin/:id', protect, authorize('Super Admin', 'Admin', 'Chapter Admin'), async (req, res) => {
  try {
